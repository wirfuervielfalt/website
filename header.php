      ...
      <div class="u-header__section u-header__section--light g-bg-white g-transition-0_3 g-py-10">
        <nav class="js-mega-menu navbar navbar-expand-lg hs-menu-initialized hs-menu-horizontal">
          <div class="container">
            ...
            <!-- Logo -->
            <a href="https://layout.wirfuervielfalt.de/index.html" class="navbar-brand d-flex">
			 <svg width="180px" height="70px"  viewBox="0 0 180 70" xmlns="
			  ...
			  /* <img class="g-width-100 g-height-auto" src="<?= $page->intro_logo->httpUrl; ?> alt="Wir für Vielfalt Logo">
             
			  <svg height="30" width="200" xmlns:xlink="http://www.w3.org/1999/xlink">
			  <a xlink:href="https://www.w3schools.com/graphics/" target="_blank">
				<text x="0" y="15" fill="red">#wirfuerfielfalt</text>
			  </a>
			</svg>
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--lg" id="navBar">
              <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                ...
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="<?= $pages->get("id=1048")->httpUrl; ?>" class="nav-link g-py-7 g-px-0">Intro</a>
                </li>
				  <!-- Intro -->
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="<?= $pages->get("id=1021")->httpUrl; ?>" class="nav-link g-py-7 g-px-0"><?= $pages->get("id=1021")->title; ?></a>
                </li>
				<?php
...
foreach($languages as $language) {
  ...
  $id_p = $options[pagefor];
echo '<li class="nav-item  g-mx-10--lg g-mx-15--xl">' . "<a href=\"" . $pages->get("id=$id_p")->url . "\"> " . $language->title . "</a></li>&nbsp;";
}
